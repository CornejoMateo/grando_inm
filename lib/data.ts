...
export const properties: Property[] = [
  {
    ...
    price: 2500,
    location: "Alberdi 101, Centro, Córdoba, Argentina",
    shortLocation: "Alberdi 101, Río Cuarto",
    ...
    features: ["Estacionamiento", "Piscina", "Gimnasio", "Balcon", "Aire acondicionado"],
    coordinates: { lat: 40.7128, lng: -74.006 },
  },
  {
    id: "2",
    title: "Estudio acogedor cerca de la plaza",
    price: 1200,
    location: "San Martin 500, Río Cuarto, Córdoba, Argentina",
    shortLocation: "San Martin 500, Río Cuarto",
    ...
    features: ["Lavanderia", "Aparcamiento para bicicletas", "Jardin"],
    coordinates: { lat: 40.7736, lng: -73.9566 },
  },
  {
    id: "3",
    title: "Departamento microcentro",
    price: 8500,
    location: "Buenos Aires 123, Río Cuarto, Córdoba, Argentina",
